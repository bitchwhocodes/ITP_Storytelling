...
public class ObjectDropper : MonoBehaviour
{
    ...
    void Spawn(float rate)
    {
        ...
        if (seconds > rate)
        {
            ...
            GameObject tempObject = Instantiate(objects[randomObj],position,Quaternion.identity) as GameObject;
            tempObject.transform.parent = tr;
